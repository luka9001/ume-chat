...
<head>
    ...
    <script type="text/javascript">
        ...
        function onopen() {
            ...
            // 登录
            var login_data = '{"type":"login","client_name":"' + name.replace(/"/g, '\\"') + '","client_nickname":"test","room_id":"<?php echo isset($_GET['room_id']) ? $_GET['room_id'] : 1?>"}';
...
<div class="container">
    <div class="row clearfix">
        ...
        <div class="col-md-3 column">
            ...
            <a href="http://workerman.net:8383" target="_blank"><img style="width:252px;margin-left:5px;"
                                                                     src="/img/workerman-todpole.png"></a>
        </div>
    </div>
</div>
